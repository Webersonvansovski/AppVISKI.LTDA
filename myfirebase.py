...
class MyFirebase():
    API_KEY = "AIzaSyBYZDhsuCm-Eyj-oiy3ttAn_UDpFatm-rk"
    ...
    def criar_conta(self, email, senha):
        ...
        if requisicao.ok:
            ...
            req_id = requests.get(f"https://aplicativovendasvski-default-rtdb.firebaseio.com/proximo_id_vendedor.json?auth={self.id_token}")
            id_vendedor = req_id.json()

            link = f"https://aplicativovendasvski-default-rtdb.firebaseio.com/{local_id}.json?auth={self.id_token}"
            ...
            requests.patch(f"https://aplicativovendasvski-default-rtdb.firebaseio.com/.json?auth={self.id_token}", data=info_id_vendedor)
